...
--
-- Host: Nope :P    Database: grader.ga
-- ------------------------------------------------------
...
CREATE TABLE `submission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6827 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-14 16:09:05
