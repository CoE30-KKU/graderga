    ...
    <link href="https://fonts.googleapis.com/css2?family=Kanit:wght@400;700&family=IBM+Plex+Sans+Thai:wght@500;700&family=Inter:wght@500;700&display=swap" rel="stylesheet">
...
<meta property="og:image" content="https://grader.pondja.com/static/elements/logo/logo.jpg" />
    <meta property="og:image:width" content="194" />
    <meta property="og:image:height" content="194" />
    <meta property="og:title" content="Garedami" />
    <title>Garedami</title>
    <meta property="og:description" content="The Computer Engineering of Khon Kaen University Student-Made grader." />
    <meta name="twitter:card" content="summary"></meta>
    <link rel="image_src" href="https://grader.pondja.com/static/elements/logo/logo.jpg" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?php echo $current_url; ?>" />

    <!-- Bootstrap -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css" integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous">
    <link href="https://cdn.p0nd.dev/mdbootstrap-4.19.1/css/mdb.min.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="https://cdn.p0nd.dev/mdbootstrap-4.19.1/js/mdb.min.js"></script>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-WD5R13YM08"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-WD5R13YM08');
    </script>
